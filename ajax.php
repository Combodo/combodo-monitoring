...
namespace Combodo\iTop\Integrity\LogManagement;
...
$oAjaxOperationsController = new AjaxOperationsController(MODULESROOT.'combodo-monitoring/src/view', 'combodo-monitoring');
