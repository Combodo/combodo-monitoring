...
{
	public const STRTOTIME_MIN_STARTDATE = "STRTOTIME_MIN_STARTDATE";
	...
	public function GetMetrics(): ?array
	{
		...
		foreach ($aSynchroLogObjects as $sSynchroSourceName => $oSynchroLog) {
			...
			$aMetrics[] = new MonitoringMetric(
				$this->sMetricName.'replica_count',
			...
			$aMetrics[] = new MonitoringMetric(
				$this->sMetricName.'inminutes_age',
			...
			$aMetrics[] = new MonitoringMetric(
				$this->sMetricName.'inseconds_elapsed',
