...
class ControllerTest extends ItopDataTestCase
{
	 ...
	 */
	public function testReadSingleMetrics(
		array $aMetricConf,
		int $iExpectedMetricCount,
		?string $sExpectedName = null,
		?string $sExpectedDesc = null,
		?int $iExpectedValue = 666,
		?array $aExpectedLabels = null
	) {
	...
	public function testReadMetrics_OqlGroupByWithDynamicLabels()
	{
		...
		$this->testReadSingleMetrics(
			$aConf,
			1,
			'itop_user_count',
			'Nb of URP_UserProfile par type',
			1,
